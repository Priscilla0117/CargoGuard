...
| Preliminary validation — 15 | Original plus four development challenge sets; 349 unit tests and 228 local HTTP checks in the 3.2 release candidate; fail-closed independent organiser-scoring gate; separately dated hosted evidence in CLOUD_RELEASE.md | Explain development-vs-hold-out distinction; do not equate the automated score with judging marks |
