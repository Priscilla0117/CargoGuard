...
| Preliminary validation — 15 | Original plus four development challenge sets; 314 regression tests after the laptop/revision refresh; fail-closed independent organiser-scoring gate; release evidence in CLOUD_RELEASE.md and LAPTOP_WORKSPACE.md | Explain development-vs-hold-out distinction; do not equate the automated score with judging marks |
