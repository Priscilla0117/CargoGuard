...
| Preliminary validation — 15 | Original plus four development challenge sets; 195 discovered regression tests; fail-closed independent organiser-scoring gate; hosted evidence in CLOUD_RELEASE.md | Explain development-vs-hold-out distinction; do not equate the automated score with judging marks |
