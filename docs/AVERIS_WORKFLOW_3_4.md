...
2. Inspect differences using the visible **View source** and **Correct reading** actions. Long values wrap. The correction dialog shows nearby source text and opens the original in another tab without losing the edit.
3. **Correct reading** fixes what the software extracted. A typed value unsupported by the original field remains **Needs review**, even when it equals the SI. Confirm a difficult scan through transcription/recovery, or obtain a revised document. Original bytes and earlier revisions remain unchanged.
...
| Automated regression suite | 640 passed, 0 failed or skipped |
...
| Browser review | Inbox, compact comparison, source excerpt, unsupported-edit preview, reply and follow-up screens inspected |
