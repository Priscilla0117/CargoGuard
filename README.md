...
The [live CargoGuard application](https://cargoguard-averis.onrender.com/) was updated from the final-round branch at commit `69f2519` on **24 September 2026 at 19:16 MYT**. The release fixes the Office.js navigation crash and gives every workspace page a consistent sidebar. All **636 regression tests**, GitHub CI, **30 hosted release assertions**, **7 retained-data checks**, and desktop/mobile navigation checks passed. See the [navigation release and rollback record](docs/NAVIGATION_RELEASE_20260924.md). Engine **3.4.1** and the database schema are unchanged. The public service retains isolated **demo workspaces with organiser samples**; it is not configured as an employee team or corporate SSO deployment. Main remains unchanged and automatic deployment is off.
